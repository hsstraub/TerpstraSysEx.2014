...
public:
    TerpstraKey(LumatoneKeyType newKeyType = LumatoneKeyType::disabled) { noteNumber = 0; channelNumber = 1; colour = 0; keyType = newKeyType; ccFaderDefault = true; };
    ...
    TerpstraKey withColour(int newColour) const { return TerpstraKey(keyType, channelNumber, noteNumber, newColour, ccFaderDefault); }
