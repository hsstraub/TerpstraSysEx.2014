...
public:
    ...
    juce::Image resizeImage(const Image& src, int widthOut, int heightOut, String filter_name = "lanczos3", float source_gamma = 1.0f)
    {
...
private:
    ...
    juce::Image resizeImageGeldreich(const Image& src, int dst_width, int dst_height, const char* filter_name, float source_gamma)
    {
        int n = 1;
