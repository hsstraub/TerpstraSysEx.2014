...
//==============================================================================
IncrMidiNotesMapping::IncrMidiNotesMapping (int& scaleSizeReference)
...
void IncrMidiNotesMapping::onUpdateScaleSize()
{
    if ( isVisible())
    {
        this->mappingLogic.setMaxMidiNote(scaleSize-1);
    }
}
